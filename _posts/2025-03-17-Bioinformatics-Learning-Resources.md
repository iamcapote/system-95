...
- **Introductory Bioinformatics Courses**  
  For absolute beginners, check out:
  - [Biology Meets Programming: Bioinformatics for Beginners](https://www.coursera.org/learn/bioinformatics) (Coursera) – teaching bioinformatics algorithms with hands-on Python exercises.
  - [Introduction to Bioinformatics](https://www.youtube.com/playlist?list=PL1ay9ko4A8skY0YtLrJ9XhE9c6Q0o6sU0) (Middle East Technical University OpenCourseWare on YouTube) – a self-paced video lecture series covering fundamental concepts.

- **edX Programs**  
  - [IsraelX: Essentials of Genomics and Biomedical Informatics](https://www.edx.org/course/essentials-of-genomics-and-biomedical-informatics) – a 12-week comprehensive course in genomics and data analysis.
  - Harvard’s [PH525x Biomedical Data Science series](https://rafalab.github.io/pages/harvardx.html) (on edX/HarvardX) – focuses on R programming and genomic data analysis.

- **YouTube Lecture Series**  
  - [Bioinformatics Course](https://www.youtube.com/playlist?list=PL2D8FAE9E9C12D9C5) (Harvard) by Prof. Xiaole Shirley Liu offers advanced lectures on genomics, bioinformatics in cancer research, and machine learning applications.
  - [Bioinformatics Lecture Series](https://www.youtube.com/playlist?list=PLpQLYyC4yoY4z2KxVh7r2bVw1x5n7kG6a) (Dr. Nathaniel Jue) provides in-depth tutorials on sequence alignment, phylogenetics, and tools like BLAST and ClustalW.

- **Other Platforms**  
  - [Bioinformatic Methods I & II](https://www.coursera.org/learn/bioinformatics-methods-1) (University of Toronto) cover practical techniques in data searches, phylogeny, and comparative genomics.
  - Alison’s free [Diploma in Bioinformatics](https://alison.com/course/diploma-in-bioinformatics) (10–15 hours) covers the basics of sequencing, algorithms, and applications.
  - Udemy offers free modules such as [Computational Gene Expression Analysis with Python](https://www.udemy.com/course/computational-gene-expression-analysis-with-python/) (using Python, pandas, and SciPy on RNA-seq data) along with short courses on DNA sequence analysis.
  - **University OpenCourseWare**  
    MIT OpenCourseWare provides full materials for courses like:
    - [Foundations of Computational & Systems Biology](https://ocw.mit.edu/courses/7-91j-foundations-of-computational-and-systems-biology-spring-2014/)
    - [Bioinformatics & Proteomics](https://ocw.mit.edu/courses/7-91j-foundations-of-computational-and-systems-biology-spring-2014/)
...
- **A Primer for Computational Biology (Shawn O'Neil)**  
  A comprehensive open textbook (CC BY-NC-SA) that teaches essential skills for data-rich biological research, including programming (Python, R), data handling, statistics, and basic bioinformatics concepts. Available via:
  - [Open Textbook Library](https://open.umn.edu/opentextbooks/textbooks/a-primer-for-computational-biology)
  - [LibreTexts](https://bio.libretexts.org/Bookshelves/Computational_Biology/A_Primer_for_Computational_Biology)

- **NCBI Bookshelf**  
  Offers free online books and manuals on bioinformatics:
  - [The NCBI Handbook (2nd ed.)](https://www.ncbi.nlm.nih.gov/books/NBK143764/) – tutorial-style chapters on using NCBI databases and tools.
  - [Bioinformatics in Tropical Disease Research: A Practical and Case-Study Approach](https://www.ncbi.nlm.nih.gov/books/NBK6825/) – teaches bioinformatics methods with real-world case studies in infectious disease.

- **Bioinformatics Algorithms**  
  The popular textbook *Bioinformatics Algorithms* by Compeau & Pevzner has an interactive online version at [Bioinformatics Algorithms Online](https://bioinformaticsalgorithms.org/), offering free chapters, lecture videos, and coding problem sets.

- **Biopython and Bioconductor Documentation**  
  - [Biopython Tutorial and Cookbook](https://biopython.org/DIST/docs/tutorial/Tutorial.html) – teaches Python programming for biological data analysis.
  - [Bioconductor project](https://www.bioconductor.org/) – provides extensive manuals and vignettes for R packages used in genomics.

- **Miscellaneous Free Texts**  
  - The [Bioinformatics Workbook](https://bioinformaticsworkbook.org/) (Iowa State University) is an online tutorial series covering topics from UNIX basics to advanced bioinformatics.
  - Older editions or specialized materials, such as the [UCSC Genome Browser User's Guide](https://genome.ucsc.edu/goldenPath/help/hgTracksHelp.html), can also be valuable resources.
...
- **Visualization**: Genome browsers such as the [UCSC Genome Browser](http://genome.ucsc.edu) and [Ensembl](http://ensembl.org), and desktop applications like IGV (Integrative Genomics Viewer).

*Source: [OmicsTutorials](https://omicstutorials.com)*
...
- **ExPASy Suite**: Provides free web tools for protein identification, motif scanning (PROSITE), and even 3D structure modeling via services like [SWISS-MODEL](https://swissmodel.expasy.org).

*Source: [KonanBio](https://konanbio.com)*
...
*Sources: [OmicsTutorials](https://omicstutorials.com) and [KonanBio](https://konanbio.com)*

### Bioinformatics Libraries and Frameworks
- **Python Libraries**: [Biopython](https://biopython.org) provides modules for sequence parsing, BLAST integration, and more.
- **Other Languages**: Libraries such as BioPerl, BioJava, and BioRuby offer routines for common bioinformatics tasks.
- **R Packages**: The [Bioconductor](https://www.bioconductor.org) project offers a comprehensive collection of packages for statistical genomics and high-throughput data analysis.

*Source: [KonanBio](https://konanbio.com)*

### Workflow and Analysis Platforms
- **Galaxy**: A popular web-based platform for constructing and executing bioinformatics pipelines. Visit the [Galaxy Project](https://galaxyproject.org) for more details.
- **Pipeline Frameworks**: Tools like Nextflow and Snakemake help create reproducible analysis pipelines.
- **Containerization and Package Management**: Docker/Singularity and package managers like [Bioconda](https://bioconda.github.io) simplify the installation and management of bioinformatics software.
...
- **Reddit**  
  The subreddit [r/bioinformatics](https://www.reddit.com/r/bioinformatics) offers discussions on the latest developments, career advice, and practical problems.  
  *Source: [OmicsTutorials](https://omicstutorials.com)*
...
- **Bioinformatics Slack Groups**  
  - **Bioinformatics Research Network (BRN) Slack**: A global network for advice, collaboration, and mentorship.  
    *Source: [BioresNET](https://bioresnet.org)*
  - **NIH’s BYOB Slack**: An informal community-led forum focused on practical problem-solving and tool sharing.  
    *Source: [NIH Bioinformatics](https://bioinformatics.ccr.cancer.gov)*
...
- **Special Interest Groups & Mailing Lists**  
  Many organizations (e.g., ISCB, NIH’s Bioinformatics SIG) offer free mailing lists or groups for seminars, discussions, and networking.
...
- **Bioinformatics (OUP)**  
  ...
  *Source: [OUP Academic](https://academic.oup.com)*
...
- **Rosalind**  
  ...
  Visit [Rosalind](http://rosalind.info) to get started.
...
- **Bioinformatics.ca (Canadian Bioinformatics Workshops)**  
  ...
  Visit [Bioinformatics.ca](http://bioinformatics.ca).
...
- **EMBL-EBI Training**  
  ...
  Visit [EMBL-EBI Training](https://www.ebi.ac.uk/training).
...
- **Data Carpentry (Genomics)**  
  ...
  Visit [Data Carpentry Genomics](https://datacarpentry.org/genomics-workshop).
...
- **Awesome Bioinformatics Education**  
  ...
  Visit [Awesome Bioinformatics Education on GitHub](https://github.com/lskatz/awesome-bioinformatics-education).
...
- **Webinars and Virtual Workshops**  
  ...
  *Source: [EMBL-EBI](https://www.ebi.ac.uk)*
...
- **Genome Browsers**  
  Explore reference genomes with:
  - [UCSC Genome Browser](http://genome.ucsc.edu)
  - [Ensembl](http://ensembl.org)

- **Protein Databases**  
  - [Protein Data Bank (PDB)](https://www.rcsb.org) for 3D structural data.
...
- **Specialty Omics Databases**  
  Domain-specific resources such as PRIDE (proteomics), MassIVE (mass spectrometry), Transcriptome Sequence Archive, Expression Atlas (transcriptomics), and HMDB (metabolomics).

- **Large-Scale Project Data**  
  Public datasets from projects like:
...
- **Python for Bioinformatics**  
  - [Biopython Tutorial and Cookbook](https://biopython.org/DIST/docs/tutorial/Tutorial.html) teaches Python programming with biological examples.
  - [Python for Biologists](https://www.pythonforbiologists.com) offers tutorials for common bioinformatics tasks (e.g., parsing FASTA/FASTQ files, automating BLAST searches).
...
- **R for Bioinformatics**  
  - [Bioconductor](https://www.bioconductor.org) offers extensive tutorials, vignettes, and complete workflow examples (e.g., RNA-seq analysis with DESeq2).
  ...
  - The free online book [R for Data Science](https://r4ds.had.co.nz) is also recommended.

- **Software Carpentry Lessons**  
  Open lessons on shell scripting, version control, and programming in R/Python—often with bioinformatics examples.  
  *Source: [Biostars](https://biostars.org)*

- **Coding Challenges and Notebooks**  
  Platforms like Project Euler, Codewars, and Kaggle offer problems and datasets for practicing bioinformatics coding. Many educators also share Jupyter notebooks (e.g., from *Bioinformatics Data Skills* by Vince Buffalo) on GitHub.
...
- **Blogs**  
  Blogs such as RNA-Seq Blog, Bits of DNA, Byte Size Biology, and OMGenomics offer tutorials, commentary, and real-world insights.
...
- **Social Media & Discussion**  
  Follow Twitter hashtags like **#bioinformatics** or accounts such as [@BioinfoTip](https://twitter.com/BioinfoTip) for daily tips. Facebook and LinkedIn also host groups dedicated to bioinformatics.
